...
app.get('/',  function(req,res){
    ...
    let arr=[];
    arr.push({"url1":"http://159.89.50.0:3000/getSentiment"});
    arr.push({"url2":"http://159.89.50.0:3000/getLanguage"});
    arr.push({"url3":"http://159.89.50.0:3000/getKeyPhrase"});
    arr.push({"swagger":"http://159.89.50.0:3000/docs"});
    res.json(arr);
